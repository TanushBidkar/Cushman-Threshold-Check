...
def main():
    print("CWI Validator - Amount Training Phase (ZEROS EXCLUDED FROM ALL CALCULATIONS)")
    print("="*80)
    ...
    model_path = os.path.join(output_folder, "trained_model_sqfeet_zero_aware_logic_amount_ICICI.pkl")
    validator.save_model(model_path)
   
    validator.display_training_summary()
   
    # Generate enhanced detailed report
    report_path = os.path.join(output_folder, "training_report_sqfeet_weighted_avg_amount_ZERO_EXCLUDED.txt")
