...
class CWIRateValidator:
    ...
    def extract_sqfeet_from_filename(self, filename):
        """Extract square feet range from filename for West zone (500-2500, 2500-5000, 5000+)"""
        filename_lower = filename.lower()

        # Patterns for West zone ranges
        patterns = [
    ...
    def display_training_summary(self):
        ...
        print("="*70)
def main():
    print("CWI Validator - WEST ZONE Rate Training Phase (Weighted Avg Excludes Zeros)")
    print("="*80)
   
    validator = CWIRateValidator()
   
    # Specific path for ICICI
    training_folder = r"C:\Users\Tanush.Bidkar\Downloads\Zone wise\West\training files"
    ...
    output_folder = r"C:\Users\Tanush.Bidkar\Downloads\Zone wise\West"
   
    if not os.path.exists(output_folder):
        os.makedirs(output_folder)

    # Save the RATE model
    model_path = os.path.join(output_folder, "trained_model_sqfeet_zero_aware_logic_rate_WEST.pkl")
