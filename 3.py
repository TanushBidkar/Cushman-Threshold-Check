...
class CWIGroupedValidator:
    def __init__(self):
        ...
        self.known_groups = {
            ...
            'Electricity and Diesel Expense': ['electricity', 'diesel', 'electricity and diesel', 'electricity diesel']
        }
...
def main():
    print("="*80)
    print("CWI GROUPED VALIDATOR - Training Phase (With Weighted Averages)")
    print("="*80)
    ...
    model_path = os.path.join(output_folder, "trained_model_sqfeet_zero_aware_logic_grouped_ICICI.pkl")
    validator.save_model(model_path)
    
    validator.display_training_summary()
    
    report_path = os.path.join(output_folder, "training_report_sqfeet_zero_aware_grouped_weighted_avg.txt")
    with open(report_path, 'w', encoding='utf-8') as f:
        f.write("CWI GROUPED VALIDATOR Training Report (With Weighted Averages)\n")
        f.write("="*80 + "\n\n")
