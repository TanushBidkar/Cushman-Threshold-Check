...
class CWIRateValidator:
    ...
    def display_training_summary(self):
        ...
        print("="*70)
def main():
    print("CWI Validator - HDFC Rate Training Phase (Weighted Avg Excludes Zeros, 250 sqft intervals)")
    print("="*80)
    ...
    # Save the RATE model
    model_path = os.path.join(output_folder, "trained_model_sqfeet_zero_aware_logic_rate_HDFC.pkl")
    validator.save_model(model_path)
   
    validator.display_training_summary()
   
    # Generate enhanced detailed report for RATES
    report_path = os.path.join(output_folder, "training_report_sqfeet_weighted_avg_rate_HDFC.txt")
