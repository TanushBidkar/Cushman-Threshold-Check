...
class CWIValidator:
    def __init__(self):
        ...
        self.sqfeet_ranges = {
            ...
            '13000-13999': {'quantity_ranges': {}, 'service_code_data': defaultdict(list)},
            '14000-15999': {'quantity_ranges': {}, 'service_code_data': defaultdict(list)},
            '16000-17999': {'quantity_ranges': {}, 'service_code_data': defaultdict(list)},
            '18000-19999': {'quantity_ranges': {}, 'service_code_data': defaultdict(list)},
            '20000-21999': {'quantity_ranges': {}, 'service_code_data': defaultdict(list)},
            '22000-23999': {'quantity_ranges': {}, 'service_code_data': defaultdict(list)},
            '24000-25999': {'quantity_ranges': {}, 'service_code_data': defaultdict(list)},
            '26000-27999': {'quantity_ranges': {}, 'service_code_data': defaultdict(list)},
            '28000-29999': {'quantity_ranges': {}, 'service_code_data': defaultdict(list)},
            '30000+': {'quantity_ranges': {}, 'service_code_data': defaultdict(list)}
        }
    ...
    def extract_sqfeet_from_filename(self, filename):
        ...
        if numbers:
            for num_str in numbers:
                num = int(num_str)
                # Ignore small numbers that aren't area
                if num < 1000: continue 
                
                if 1000 <= num <= 3999: return '1000-3999'
                elif 4000 <= num <= 4999: return '4000-4999'
                elif 5000 <= num <= 5999: return '5000-5999'
                elif 6000 <= num <= 6999: return '6000-6999'
                elif 7000 <= num <= 7999: return '7000-7999'
                elif 8000 <= num <= 8999: return '8000-8999'
                elif 9000 <= num <= 10500: return '9000-10500'
                elif 10501 <= num <= 12999: return '10501-12999'
                elif 13000 <= num <= 13999: return '13000-13999'
                elif 14000 <= num <= 15999: return '14000-15999'
                elif 16000 <= num <= 17999: return '16000-17999'
                elif 18000 <= num <= 19999: return '18000-19999'
                elif 20000 <= num <= 21999: return '20000-21999'
                elif 22000 <= num <= 23999: return '22000-23999'
                elif 24000 <= num <= 25999: return '24000-25999'
                elif 26000 <= num <= 27999: return '26000-27999'
                elif 28000 <= num <= 29999: return '28000-29999'
                elif num >= 30000: return '30000+'
        return None
    ...
    def load_training_data(self, base_folder):
        """Load all Excel files from Smart folder across all zones (East, West, North, South)"""
        training_data = []
        ...
        for zone in zones:
            ...
            # Look for Smart folder in each zone
            Smart_path = os.path.join(zone_path, 'Smart')
            if not os.path.exists(Smart_path):
                print(f"Warning: Smart folder not found in {zone}, skipping...")
                continue
            
            print(f"\nProcessing Zone: {zone}")
            
            # Get all subfolders in Smart (e.g., 10371sqft_Nallasopara)
            for project_folder in os.listdir(Smart_path):
                project_path = os.path.join(Smart_path, project_folder)
...
def main():
    ...
    if not training_data:
        ...
        print("\nExpected structure:")
        print("  Base Folder/")
        print("    East/Smart/[project folders with sqft]/[excel files]")
        print("    West/Smart/[project folders with sqft]/[excel files]")
        print("    North/Smart/[project folders with sqft]/[excel files]")
        print("    South/Smart/[project folders with sqft]/[excel files]")
        return
    ...
    model_path = os.path.join(output_folder, "trained_model_service_code_smart_pan_india.pkl")
