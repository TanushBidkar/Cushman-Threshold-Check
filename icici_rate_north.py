...
class CWIRateValidator:
    def __init__(self):
        ...
        self.sqfeet_ranges = {
            '500-2500': {'rate_ranges': {}, 'particulars_data': defaultdict(list), 'particulars_file_data': defaultdict(list)},
            '2500-5000': {'rate_ranges': {}, 'particulars_data': defaultdict(list), 'particulars_file_data': defaultdict(list)},
    ...
    def extract_sqfeet_from_filename(self, filename):
        """Extract square feet range from filename for North zone (500-2500, 2500-5000, 5000+)"""
        filename_lower = filename.lower()

        # Patterns for North zone ranges
        patterns = [
    ...
    def display_training_summary(self):
        ...
        print("="*70)
def main():
    print("CWI Validator - North ZONE Rate Training Phase (Weighted Avg Excludes Zeros)")
    print("="*80)
   
    validator = CWIRateValidator()
   
    # Specific path for ICICI
    training_folder = r"C:\Users\Tanush.Bidkar\Downloads\Zone wise\North\training files"
    ...
    if not training_data:
        ...
        print("  - 'data_500-2500.xlsx'")
        print("  - 'cwi_2500-5000.xlsx'")
        print("  - 'project_5000+.xlsx'")
        return
    ...
    output_folder = r"C:\Users\Tanush.Bidkar\Downloads\Zone wise\North"
   
    if not os.path.exists(output_folder):
        os.makedirs(output_folder)

    # Save the RATE model
    model_path = os.path.join(output_folder, "trained_model_sqfeet_zero_aware_logic_rate_NORTH.pkl")
